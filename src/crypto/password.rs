...
/// allow any non-blank password. `None` (no password) is handled by the callers
/// — it simply means password login is disabled for that user. First-boot
/// generated passwords (32 chars, CSPRNG) pass trivially.
