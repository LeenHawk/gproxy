...
use crate::providers::endpoints::{
    ...
    OpenAIModelGet, OpenAIModelsList, OpenAIResponses, OpenAIResponsesInputTokens,
    UpstreamRequest,
};
...
impl OpenAIChatCompletions for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIResponses for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIResponsesInputTokens for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIModelsList for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIModelGet for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIConversations for GeminiCliProvider {
...
#[async_trait::async_trait]
impl OpenAIConversationItems for GeminiCliProvider {
