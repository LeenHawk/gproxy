...
pub(in crate::transform::count_tokens) fn openai_service_tier_to_claude_speed(
    service_tier: Option<openai::ServiceTier>,
) -> Option<claude::Speed> {
    match service_tier {
...
pub(in crate::transform::count_tokens) fn claude_speed_to_openai(
...
pub(in crate::transform::count_tokens) fn claude_speed_to_gemini(
    speed: Option<claude::Speed>,
) -> Option<gemini::ServiceTier> {
    match speed {
