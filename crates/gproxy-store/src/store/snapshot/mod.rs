...
impl Store {
    pub async fn control_snapshot(&self) -> Result<ControlSnapshot, StoreError> {
        let statements = vec![
            ...
            control_query::select_provider_model_modalities()?,
            control_query::select_provider_model_parameters()?,
            control_query::select_provider_model_reasoning_levels()?,
            control_query::select_provider_model_service_tiers()?,
            control_query::select_provider_model_methods()?,
