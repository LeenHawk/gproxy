...
pub(super) static ROUTES: &[ChannelSupport] = &[
    ...
    route!(unsupported CreateEmbedding, claude),
    ...
    route!(unsupported CreateImage, claude),
    route!(pass CreateImage, gemini),
    route!(pass EditImage, openai),
    route!(unsupported EditImage, claude),
    route!(unsupported EditImage, gemini),
    ...
    route!(unsupported CompactContent, claude),
    route!(unsupported CompactContent, gemini),
];
