...
fn upstream_path(operation: Operation, model: &str) -> String {
    match operation {
        ...
        Operation::GuardianReview => "/guardian".into(),
        Operation::GuardianClassify => "/guardian-classifier".into(),
...
fn endpoint_override(ctx: &PrepareCtx<'_>) -> Option<String> {
    let name = match ctx.key.operation() {
        ...
        Operation::GuardianReview | Operation::GuardianClassify => return None,
