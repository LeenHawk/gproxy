...
pub(super) static ROUTES: &[ChannelSupport] = &[
    ...
    route!(pass BatchCreateEmbedding, gemini),
    route!(pass CreateImage, gemini),
    route!(pass CreateVideo, gemini),
    route!(pass RetrieveVideo, gemini),
    route!(pass CreateFile, gemini),
    route!(pass ListFiles, gemini),
    route!(pass RetrieveFile, gemini),
    route!(pass RetrieveFileContent, gemini),
    route!(pass DeleteFile, gemini),
