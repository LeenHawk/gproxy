...
impl KnownResponseStreamEvent {
    pub fn event_type(&self) -> ResponseStreamEventTypeKnown {
        ...
        match self {
            ...
            Self::ResponseSteerAccepted(_) => T::ResponseSteerAccepted,
            Self::ResponseSteerPending(_) => T::ResponseSteerPending,
            Self::ResponseSteerFailed(_) => T::ResponseSteerFailed,
