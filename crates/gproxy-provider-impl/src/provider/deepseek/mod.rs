...
#[async_trait]
impl DispatchProvider for DeepSeekProvider {
            ...
            .execute(scope.clone(), |credential| {
                ...
                async move {
                    ...
                    let meta = UpstreamRecordMeta {
                        ...
                        operation: "deepseek.chat.completions".to_string(),
                        model: Some(model),
            ...
            .execute(scope.clone(), |credential| {
                ...
                async move {
                    ...
                    let meta = UpstreamRecordMeta {
                        ...
                        provider_id: ctx.provider_id,
                        credential_id: Some(credential.value().id),
                        operation: "deepseek.input_tokens".to_string(),
                        model: Some(model),
                        request_method: "POST".to_string(),
            ...
            .execute(scope.clone(), |credential| {
                ...
                async move {
                    ...
                    let meta = UpstreamRecordMeta {
                        ...
                        provider_id: ctx.provider_id,
                        credential_id: Some(credential.value().id),
                        operation: "deepseek.models_list".to_string(),
                        model: None,
            ...
            .execute(scope.clone(), |credential| {
                ...
                async move {
                    ...
                    let meta = UpstreamRecordMeta {
                        ...
                        provider_id: ctx.provider_id,
                        credential_id: Some(credential.value().id),
                        operation: "deepseek.models_get".to_string(),
                        model: Some(model),
                        request_method: "GET".to_string(),
                        request_path: path,
                        request_query: None,
