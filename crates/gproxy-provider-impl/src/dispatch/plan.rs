...
pub enum GenerateContentPlan {
    ...
    Claude2OpenAIResponses(
        gproxy_protocol::claude::create_message::request::CreateMessageRequest,
    ),
...
pub enum CountTokensPlan {
    ...
    Claude2OpenAIInputTokens(
        gproxy_protocol::claude::count_tokens::request::CountTokensRequest,
    ),
...
pub(super) fn upstream_usage_for_plan(plan: &TransformPlan) -> UsageKind {
    match plan {
        TransformPlan::GenerateContent(plan) => match plan {
            ...
            GenerateContentPlan::Claude2OpenAIResponses(_) => UsageKind::OpenAIResponses,
        ...
        TransformPlan::StreamContent(plan) => match plan {
            ...
            StreamContentPlan::Claude2OpenAIResponses(_) => UsageKind::OpenAIResponses,
