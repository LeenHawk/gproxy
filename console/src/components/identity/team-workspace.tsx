...
export function TeamWorkspace({ access, selectedId, panel, pending, onSelect, onBack, onPanel, onCreate, onToggle, onSave }: {
  ...
  onSave: (team: TeamDto, value: TeamWriteRequest) => Promise<void>
}) {
