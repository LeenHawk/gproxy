...
import { ActivityIcon, BookOpenIcon, CableIcon, CircleDollarSignIcon, KeyRoundIcon, LogsIcon, LogOutIcon, NetworkIcon, PanelLeftCloseIcon, PanelLeftOpenIcon, RouteIcon, SettingsIcon } from "lucide-react"
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="hidden flex-col gap-2 border-t p-3 lg:flex">
            <div className={cn("flex items-center justify-between gap-1", sidebar.collapsed && "flex-col")}>
              <LocaleControls />
              <Button asChild size="icon-sm" variant="ghost"><a href="https://github.com/LeenHawk/gproxy/tree/3.0/docs" target="_blank" rel="noreferrer" aria-label={t("common.documentation")}><BookOpenIcon aria-hidden /></a></Button>
            </div>
