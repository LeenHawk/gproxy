...
import { DefaultPricesDialog } from "@/components/pricing/default-prices-dialog"
...
export function PricingWorkspace(props: Props) {
  ...
  return <div className="flex flex-col gap-3">
    <div className="flex justify-end"><DefaultPricesDialog providerId={props.scopeProviderId ?? null} rules={props.rules} /></div>
    <WorkspaceLayout
