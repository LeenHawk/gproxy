...
const ENDPOINTS_BY_CHANNEL: Partial<Record<string, readonly EndpointKind[]>> = {
  openai: ["openai_list_models", "openai_get_model", "openai_chat_completions", "openai_responses", "openai_realtime", "openai_embeddings", "openai_audio_speech", "openai_audio_transcriptions", "openai_audio_translations", "image_generations", "image_edits", "openai_compact"],
