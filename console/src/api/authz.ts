...
export interface Quota { id: number; scope: Scope; scope_id: number; quota_total: string; quota_daily: string | null; quota_weekly: string | null; quota_monthly: string | null; quota_5h: string | null; quota_7d: string | null; cost_used: string; day_used: string; day_anchor: number; week_used: string; week_anchor: number; month_used: string; month_anchor: number; five_hour_used: string; five_hour_anchor: number; seven_day_used: string; seven_day_anchor: number; created_at: number; updated_at: number; }
export interface QuotaInput { id?: number | null; scope: Scope; scope_id: number; quota_total: string; quota_daily?: string | null; quota_weekly?: string | null; quota_monthly?: string | null; quota_5h?: string | null; quota_7d?: string | null; cost_used: string; }
